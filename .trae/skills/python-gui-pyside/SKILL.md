...
```python
"""fcmd GUI 入口（PySide2/PySide6 双兼容）。"""
...
from fcmd import theme
from fcmd.widgets.sidebar import Sidebar
...
class MainWindow(QMainWindow):
    ...
    def _build_header(self) -> QFrame:
        ...
        title = QLabel("fcmd", objectName="headerTitle")
